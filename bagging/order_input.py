...
def order2():
    ...
    negg = tk.Entry(win,textvariable=num_egg2,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    negg.place(x=450,y=200,anchor=CENTER)
    ...
    ntea = tk.Entry(win,textvariable=num_tea2,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    ntea.place(x=450,y=290,anchor=CENTER)
    ...
    npuff = tk.Entry(win,textvariable=num_puff2,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    npuff.place(x=450,y=380,anchor=CENTER)
...
def order3():
    ...
    negg = tk.Entry(win,textvariable=num_egg3,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    negg.place(x=450,y=200,anchor=CENTER)
    ...
    ntea = tk.Entry(win,textvariable=num_tea3,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    ntea.place(x=450,y=290,anchor=CENTER)
    ...
    npuff = tk.Entry(win,textvariable=num_puff3,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    npuff.place(x=450,y=380,anchor=CENTER)
...
def order4():
    ...
    negg = tk.Entry(win,textvariable=num_egg4,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    negg.place(x=450,y=200,anchor=CENTER)
    ...
    ntea = tk.Entry(win,textvariable=num_tea4,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    ntea.place(x=450,y=290,anchor=CENTER)
    ...
    npuff = tk.Entry(win,textvariable=num_puff4,bg = '#E0E0E0',font=('Time New Roman',28)
                    ,justify='center')
    npuff.place(x=450,y=380,anchor=CENTER)
